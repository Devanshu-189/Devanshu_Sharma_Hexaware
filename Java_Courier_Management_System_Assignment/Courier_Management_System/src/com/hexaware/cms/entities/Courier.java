...
public class Courier {
    ...
    public Courier(String senderAddress, String receiverName, String receiverAddress, int weight, String status, long trackingNumber, Date deliveryDate, String senderName) {
        this(); 
