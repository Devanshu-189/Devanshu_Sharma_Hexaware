...
public class CourierUserServiceCollectionImpl implements ICourierUserService {
	...
	@Override
	public List<Courier> getAssignedOrder() { // No need for courierStaffId parameter
	    String sql = "SELECT * FROM courier WHERE STATUS = ?"; // Select all couriers
